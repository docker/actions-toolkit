...
import release_0_9_1 = require('./release-v0.9.1.json');
...
describe('download', () => {
  ...
  test.each([
    ['v0.9.1', false],
    ['latest', false],
    ['https://github.com/docker/buildx.git#v0.9.1', false],
    ['v0.9.1', true],
    ['latest', true],
    ['https://github.com/docker/buildx.git#v0.9.1', true],
  ])(
